...
public class Residence extends JavaPlugin {
    ...
    private final String[] validLanguages = { "English","German","French","Hungarian","Spanish","Chinese","Czech","Brazilian" };
            ...
            if (sender instanceof Player) {
                ...
                if(command.getName().equals("resadmin"))
                {
                    ...
                    if(args.length == 1 && args[0].equals("on"))
                    {
                        ...
                        player.sendMessage(ChatColor.YELLOW + language.getPhrase("AdminToggle",language.getPhrase("On")));
                        return true;
                    }
                    else if(args.length == 1 && args[0].equals("off"))
                    {
                        resadminToggle.remove(player.getName());
                        player.sendMessage(ChatColor.YELLOW + language.getPhrase("AdminToggle",language.getPhrase("Off")));
                        return true;
                    }
                }
