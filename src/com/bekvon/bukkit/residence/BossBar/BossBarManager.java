...
public class BossBarManager {
	...
	for (Entry<String, BossBarInfo> one : temp.entrySet()) {
	    showBar(one.getValue());
	}
    }

    public synchronized void showBar(final BossBarInfo barInfo) {
	...
	barInfo.setAutoId(Bukkit.getScheduler().scheduleSyncRepeatingTask(Residence.getInstance(), new Runnable() {
	    @Override
	    public void run() {
...
//		}
	...
	}, barInfo.getAuto(), barInfo.getAuto()));
