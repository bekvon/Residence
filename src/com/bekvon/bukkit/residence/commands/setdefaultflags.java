...
public class setdefaultflags implements cmd {
	...
	c.get(path + "Description", "Set default flags for residence or all of them");
	c.get(path + "Info", Arrays.asList("&eUsage: &6/res setdefaultflags [residenceName/all]"));
	Residence.getInstance().getLocaleManager().CommandTab.put(Arrays.asList(this.getClass().getSimpleName()), Arrays.asList(""));
    }
}
