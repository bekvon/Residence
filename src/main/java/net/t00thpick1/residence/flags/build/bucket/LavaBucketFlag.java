...
public class LavaBucketFlag extends Flag implements Listener {
    public static final LavaBucketFlag FLAG = new LavaBucketFlag(LocaleLoader.getString("Flags.Flags.LavaBucket"), FlagType.ANY, BucketFlag.FLAG);

    private LavaBucketFlag(String name, FlagType type, Flag parent) {
