...
public class FireballFlag extends Flag implements Listener {
    private FireballFlag(String flag, FlagType type, Flag parent) {
        super(flag, type, parent);
    }

    public static final FireballFlag FLAG = new FireballFlag(LocaleLoader.getString("Flags.Flags.Fireball"), FlagType.AREA_ONLY, ExplosionFlag.FLAG);
