...
public class CreeperFlag extends Flag implements Listener {
    private CreeperFlag(String flag, FlagType type, Flag parent) {
        super(flag, type, parent);
    }

    public static final CreeperFlag FLAG = new CreeperFlag(LocaleLoader.getString("Flags.Flags.Creeper"), FlagType.AREA_ONLY, ExplosionFlag.FLAG);
